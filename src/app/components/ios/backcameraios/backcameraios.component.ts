...
@Component({
  selector: 'app-backcameraios',
  templateUrl: './backcameraios.component.html',
  styleUrls: ['./backcameraios.component.scss']
})
export class BackcameraiosComponent implements OnInit {
